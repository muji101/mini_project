...
<div class="col-12 d-flex mb-5">
    ...
    {{-- sticky right --}}
    <div class="col-2 card position-sticky top-0" style="width: 17rem; height: 28rem;">
        <img src="https://preview.colorlib.com/theme/content/images/xslider_2.jpg.pagespeed.ic.MeMJUfLHS1.webp" class="card-img-top" alt="...">
        <div class="card-body">
...
<div class="col-12 d-flex my-5">
    ...
    <div class="d-flex flex-column">
        <div class="fs-4 my-5 position-relative">
            <div class="rounded-bottom" style="width: 100px; height:6px ; background: rgb(238, 173, 53); "></div>
    ...
    <div class="d-flex flex-column">
        <div class="fs-4 my-5 position-relative">
            <div class="rounded-bottom" style="width: 74px; height:6px ; background: rgb(238, 173, 53); "></div>
...
<div class="fs-4 my-5 position-relative d-flex justify-content-center">
    <div class="rounded-bottom" style="width: 180px; height:6px ; background: rgb(238, 173, 53); "></div>
...
<div class="d-flex flex-column">
    <div class="fs-2 d-flex justify-content-center my-3">
